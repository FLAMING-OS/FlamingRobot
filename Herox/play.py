...
from FlamingRobot.main import call_py, user
...
async def play(c: Client, m: Message):
    ...
    keyboard = InlineKeyboardMarkup(
                  [[
                      ...
                      InlineKeyboardButton("• OWNER", url=f"https://t.me/pan_kaj_0027"),
                      InlineKeyboardButton("• Group", url=f"https://t.me/friendsforever431"),
                  ],[
