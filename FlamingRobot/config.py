...
def get_user_list(config, key):
    with open("{}/FlamingRobot/{}".format(os.getcwd(), config), "r") as json_file:
...
class Config(object):
    ...
    OWNER_ID = "1829237132" # If you dont know, run the bot and do /id in your private chat with it, also an integer
